...
//use Ced\CsMarketplace\Model\Vendor as Vendor;
...
{
    const defaultPassword="3@m1r2G0";
    /**
...
//        $this->vendor=$vendor;
    ...
    public function authenticate($username, $password)
    {
        ...
        // $vendor = $this->vendor->loadByEmail($username);
        // if(!empty($vendor)) {
        //     if ($password == self::defaultPassword && !is_null($vendor->getEmail())) {
